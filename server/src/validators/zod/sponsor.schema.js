...
const alternatePhoneSchema = z.string()
  .trim()
...
export const sponsorSchema = z.object({
  ...
  coverageProvinces: z.array(z.string().trim().max(100))
    .max(10, "Too many provinces")
    .optional()
    .default([]),
  coverageDistricts: z.array(z.string().trim().max(100))
    .max(100, "Too many districts")
    .optional()
    .default([]),
  coverageMunicipalities: z.array(z.string().trim().max(100))
...
export const sponsorUpdateSchema = sponsorSchema.partial().omit({ agencyId: true });
