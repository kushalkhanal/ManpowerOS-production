...
const NEPAL_DISTRICTS = [
  ...
  'Ilum', 'Jajarkot', 'Jhapa', 'Jumla', 'Kailali', 'Kalikot', 'Kanchanpur', 'Kapilvastu',
  'Kaski', 'Kathmandu', 'Kavrepalanchok', 'Khotang', 'Lalitpur', 'Lamjung', 'Mahottari',
  'Makwanpur', 'Manang', 'Morang', 'Mugu', 'Mustang', 'Myagdi', 'Nawalparasi',
  'Nuwakot', 'Okhaldhunga', 'Palpa', 'Panchthar', 'Parsa', 'Parvat', 'Pyuthan',
  'Ramechhap', 'Rautahat', 'Rolpa', 'Rupandehi', 'Salyan', 'Sankhuwasabha', 'Saptari',
  'Sindhuli', 'Sindhupalchok', 'Solukhumbu', 'Sunsari', 'Surkhet', 'Syangja', 'Tanahu',
...
candidateSchema.index({ fullName: 'text', phone: 'text', nationalIdNumber: 'text' });
