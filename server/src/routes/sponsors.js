...
router.patch('/:id', validateZod(sponsorUpdateSchema), sponsorController.updateSponsor);

router.patch('/:id/role', requireRole('admin', 'manager'), validateZod(sponsorRoleUpdateSchema), sponsorController.updateRole);
router.patch('/:id/permissions', requireRole('admin', 'manager'), validateZod(sponsorPermissionsUpdateSchema), sponsorController.updatePermissions);
router.patch('/:id/assign-staff', requireRole('admin', 'manager'), validateZod(sponsorAssignStaffSchema), sponsorController.assignStaff);
router.patch('/:id/toggle-active', requireRole('admin', 'manager'), validateZod(sponsorToggleActiveSchema), sponsorController.toggleActive);
router.patch('/:id/invite-portal', requireRole('admin', 'manager'), sponsorController.invitePortal);
